...
> Create permanent links for HTML, Markdown, CSV/XLS, and generate QR codes in a static Next.js app.
...
**git-page-link-create** generates shareable links that render content directly in the browser—no backend required. It also includes a QR code generator for text and links.
...
- Internationalization (pt, en, es)
- Compatible with Next.js static export
- QR code generator for text and links (Create page)
